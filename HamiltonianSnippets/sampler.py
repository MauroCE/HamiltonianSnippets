...
def hamiltonian_snippet(N: int, T: int, mass_diag: NDArray, ESSrmin: float, sample_prior: callable, verbose: bool = True, seed: Optional[int] = None):
    ...
    while gammas[n-1] < 1.0:
        ...
        znk, nlps, nlls = leapfrog(x, v, epsilons, gammas[n-1], 1/mass_diag, compute_likelihoods_priors_gradients)
